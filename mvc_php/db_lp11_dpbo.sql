...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2022 at 12:49 PM
...
('101', 'Surasepz', 'Filsafat Meme'),
('102', 'Buzz', 'Pertukangan'),
('103', 'Lightyear', 'Seni Mesin'),
('104', 'Woody Woodpecker', 'Berkebun'),
('105', 'Mr. Potato Head', 'Sastra Akuntansi');
...
INSERT INTO `peminjaman` (`id_peminjaman`, `nim`, `id_buku`, `status`) VALUES
(1, '101', 1, 'Belum Dikembalikan'),
(2, '104', 2, 'Sudah Dikembalikan'),
(4, '105', 4, 'Belum Dikembalikan');
